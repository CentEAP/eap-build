...
By default, it builds EAP 6.2.0. You can build other versions by passing the number to the build :
...
Versions
--------
For the moment, it supports EAP 6.0.1, 6.1.0, 6.1.1 and 6.2.0.
